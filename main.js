...
//alert(mulcalc1+multi1);
var url_temp1 = "timeperiod.jsp?check="+check+"&muldata="+multi1+"&mulcalc="+mulcalc1+"&time="+new Date().getTime();
//"timeperiod.jsp?check="+check+"&muldata="+multi1+"&mulcalc="+multcalc1+"&time="+new Date().getTime()
//alert(url_temp1);
ajaxGeneric(url_temp1,function(){
...
function GenerateChart(){
	...
	var url_temp1 = "dbresults.jsp?check="+check+"&multi="+multi1+"&mulcalc="+mulcalc1+"&from="+fromdate+"&to="+todate+"&time="+new Date().getTime();    	
	alert(url_temp1);
